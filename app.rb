...
# NORECORDFOUNDERROR NOTIFICATIONS

# Product.find_by_title("Product Does not exist")
# Should return NoRecordFoundError: 'Product Does not exist' does not exist.

# Customer.find_by_name("Name Does Not Exist")
# Should return NoRecordFoundError: 'Name Does not exist' does not exist.
